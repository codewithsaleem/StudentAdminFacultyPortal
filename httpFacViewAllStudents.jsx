...
class Students extends Component {
    ...
    async fetchData() {
        ...
        let response = null;
        if (searchStr) {
            response = await http.get(`/students?${searchStr}`);
        } else {
            response = await http.get("/students?page=1");
        }
    ...
    handlePage = (num) => {
        ...
        this.callURL("/All Studentsview", queryParams);
    }
    ...
    handleOptionChange = (options) => {
        options.page = 1;
        this.callURL("/All Studentsview", options);
    }
                ...
                <div className="row">
                    ...
                    <div className="col-sm-9">
                        ...
                        <div className="row mb-2 mt-2">
                            <div className="col-sm-1"><b>Id</b></div>
                            <div className="col-sm-2"><b>Name</b></div>
                            <div className="col-sm-2"><b>Date of Birth</b></div>
                            <div className="col-sm-3"><b>About</b></div>
                            <div className="col-sm-4"><b>Courses</b></div>
                        </div>
                        {students.map((ele) => (
                            <div className="row border bg-warning">
                                <div className="col-sm-1">{ele.id}</div>
                                <div className="col-sm-2">{ele.name}</div>
                                <div className="col-sm-2">{ele.dob}</div>
                                <div className="col-sm-3">{ele.about}</div>
