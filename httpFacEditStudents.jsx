...
class EditStudents extends Component {
    state = {
        stud: [],
        formStud: { name: "", code: "", description: "", students: [] },
        edit: false,
    }
    async fetchData() {
    ...
    async postData(url, obj) {
        ...
        let { data } = response;
        this.props.history.push("/Student to Course")
    }
    ...
    render() {
        ...
        let { name, code, description, students } = this.state.formStud;
        let fnd = stud.map((ele) => ele.students)
        ...
        return (
            <div className="container mt-4">
                <h3 className="mt-3">Add students to a course</h3>
                <hr />
                ...
                <label className="form-check-label mt-2"><b>Students</b><sup className="text-danger">*</sup></label><br />
                {uniqueNames.map((opt) => (
