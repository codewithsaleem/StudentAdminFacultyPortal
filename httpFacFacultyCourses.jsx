...
class Faculty extends Component {
    ...
    handleEdit = (id) => {
        this.props.history.push(`/editFacultyCourses/${id}`)
    }
            ...
            <div className="container mt-4">
                ...
                {courses.map((ele) => (
                    <div className="row border bg-warning">
                        ...
                        <div className="col-sm-2">{ele.faculty.map((opt) => <React.Fragment key={opt}>{opt}<br /></React.Fragment>)}</div>
